...
# Project:  TestCPP.pro
# Template: app
# Command: /anaconda3/bin/qmake -o Makefile TestCPP.pro
#############################################################################
...
INCPATH       = -I. -I. -I/anaconda3/include/qt -I/anaconda3/include/qt/QtWidgets -I/anaconda3/include/qt/QtGui -I/anaconda3/include/qt/QtCore -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk/System/Library/Frameworks/AGL.framework/Headers -I/anaconda3/mkspecs/macx-clang
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = TestCPP1.0.0
DISTDIR = /Users/philippschulte/Documents/TestCPP/.tmp/TestCPP1.0.0
...
SOURCES       = qtTest.cpp \
		test.cpp moc_Zeichenflaeche.cpp
OBJECTS       = qtTest.o \
		test.o \
		moc_Zeichenflaeche.o
DIST          = /anaconda3/mkspecs/features/spec_pre.prf \
		...
		TestCPP.pro QtBeispiel.h \
		Zeichenflaeche.h qtTest.cpp \
		test.cpp
QMAKE_TARGET  = TestCPP
DESTDIR       = 
TARGET        = TestCPP.app/Contents/MacOS/TestCPP
...
$(TARGET):  $(OBJECTS)  
	@test -d TestCPP.app/Contents/MacOS/ || mkdir -p TestCPP.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: TestCPP.pro /anaconda3/mkspecs/macx-clang/qmake.conf /anaconda3/mkspecs/features/spec_pre.prf \
		/anaconda3/mkspecs/qdevice.pri \
		/anaconda3/mkspecs/features/device_config.prf \
		/anaconda3/mkspecs/common/unix.conf \
		/anaconda3/mkspecs/common/mac.conf \
...
TestCPP.app/Contents/PkgInfo: 
	@test -d TestCPP.app/Contents || mkdir -p TestCPP.app/Contents
	@$(DEL_FILE) TestCPP.app/Contents/PkgInfo
	@echo "APPL????" > TestCPP.app/Contents/PkgInfo
TestCPP.app/Contents/Resources/empty.lproj: 
	@test -d TestCPP.app/Contents/Resources || mkdir -p TestCPP.app/Contents/Resources
	@touch TestCPP.app/Contents/Resources/empty.lproj
	
TestCPP.app/Contents/Info.plist: 
	@test -d TestCPP.app/Contents || mkdir -p TestCPP.app/Contents
	@$(DEL_FILE) TestCPP.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.TestCPP,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,TestCPP,g" -e "s,@LIBRARY@,TestCPP,g" -e "s,@TYPEINFO@,????,g" /anaconda3/mkspecs/macx-clang/Info.plist.app >TestCPP.app/Contents/Info.plist

all: Makefile \
		TestCPP.app/Contents/PkgInfo \
		TestCPP.app/Contents/Resources/empty.lproj \
		TestCPP.app/Contents/Info.plist $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents QtBeispiel.h Zeichenflaeche.h $(DISTDIR)/
	$(COPY_FILE) --parents qtTest.cpp test.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_Zeichenflaeche.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Zeichenflaeche.cpp
moc_Zeichenflaeche.cpp: /anaconda3/include/qt/QtWidgets/QWidget \
		...
		moc_predefs.h \
		/anaconda3/bin/moc
	/anaconda3/bin/moc $(DEFINES) --include ./moc_predefs.h -I/anaconda3/mkspecs/macx-clang -I/Users/philippschulte/Documents/TestCPP -I/Users/philippschulte/Documents/TestCPP -I/anaconda3/include/qt -I/anaconda3/include/qt/QtWidgets -I/anaconda3/include/qt/QtGui -I/anaconda3/include/qt/QtCore -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk/usr/include Zeichenflaeche.h -o moc_Zeichenflaeche.cpp
...
qtTest.o: qtTest.cpp /anaconda3/include/qt/QtWidgets/QApplication \
		...
		/anaconda3/include/qt/QtGui/qtextoption.h \
		/anaconda3/include/qt/QtGui/qpen.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qtTest.o qtTest.cpp

test.o: test.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o test.o test.cpp

moc_Zeichenflaeche.o: moc_Zeichenflaeche.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Zeichenflaeche.o moc_Zeichenflaeche.cpp
